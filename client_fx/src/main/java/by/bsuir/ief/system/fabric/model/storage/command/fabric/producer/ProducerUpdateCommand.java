...
public class ProducerUpdateCommand extends AbstractCommand<Boolean> {
    @NotNull
    private final ProducerEntity entity;

    public ProducerUpdateCommand(@NotNull final ProducerEntity entity) {
        this.entity = entity;
    }

...
public class ConsumerCreateCommand extends AbstractCommand<Boolean> {

    @NotNull
    private final ConsumerEntity entity;

    public ConsumerCreateCommand(@NotNull final ConsumerEntity entity) {
        this.entity = entity;
    }

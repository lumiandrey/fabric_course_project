...
public class OutGoingDynamicCreateCommand extends AbstractCommand<Boolean> {

    @NotNull
    private final OutGoingDynamicEntity entity;

    public OutGoingDynamicCreateCommand(@NotNull final OutGoingDynamicEntity entity) {
        this.entity = entity;
    }
    ...
    protected Request getRequest() throws Exception {
        Request.Builder builder = new Request.Builder()
                ...
                .addMethod("add.out.going.dynamic");

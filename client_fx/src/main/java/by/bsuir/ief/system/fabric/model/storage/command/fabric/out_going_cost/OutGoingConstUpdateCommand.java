...
public class OutGoingConstUpdateCommand extends AbstractCommand<Boolean> {
    @NotNull
    private final OutGoingConstEntity entity;

    public OutGoingConstUpdateCommand(@NotNull final OutGoingConstEntity entity) {
        this.entity = entity;
    }
    ...
    protected Request getRequest() throws Exception {
        Request.Builder builder = new Request.Builder()
                ...
                .addMethod("update.out.going.const");

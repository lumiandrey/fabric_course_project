...
public class ComponentPartCreateCommand extends AbstractCommand<Boolean> {

    @NotNull
    private final ComponentPartEntity entity;

    public ComponentPartCreateCommand(@NotNull final ComponentPartEntity entity) {
        this.entity = entity;
    }

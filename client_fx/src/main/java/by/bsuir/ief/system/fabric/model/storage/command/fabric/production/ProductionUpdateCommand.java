...
public class ProductionUpdateCommand extends AbstractCommand<Boolean> {
    @NotNull
    private final ProductionEntity entity;

    public ProductionUpdateCommand(@NotNull final ProductionEntity entity) {
        this.entity = entity;
    }
